export const mockStructures = [
  ...
  {
    id: "coracao-edicao-morgue",
    modelId: "coracao-edicao-morgue",
    name: "Coração Humano — Edição Morgue 3D",
    ...
    keyFeatures: [
      "Ápice cardíaco", "Base do coração", "Face esternocostal", "Face diafragmática",
      "Aurículas", "Vasos da base", "Artérias coronárias", "Veias cardíacas"
    ],
    ...
    markers: ["Os marcadores anatômicos deste modelo ainda serão cadastrados na próxima fase."],
    sections: [
  ...
  },
  {
    ...
    name: "Corte Sagital do Sistema Reprodutor Feminino — Modelo 3D",
    viewer_type: "atlas-native",
    model_format: "glb",
    ...
    keyFeatures: [
      "Útero", "Fondo uterino", "Cuerpo uterino", "Cuello uterino / Cérvix",
      "Cavidad uterina", "Canal cervical", "Vagina", "Canal vaginal",
      "Vejiga urinaria", "Uretra femenina", "Recto", "Conducto anal",
      "Periné", "Pubis", "Sacro", "Cóccix", "Ovario", "Trompa uterina",
      "Fondo de saco vesicouterino", "Fondo de saco rectouterino / Douglas"
    ],
