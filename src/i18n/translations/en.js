...
export const en = {
  ...
  "studentHome": {
    ...
    "heroEyebrow": "Medicine • Institutional",
    "medicineDefault": "Medicine",
    "institutionalDefault": "Institutional",
    "greeting": "Hello, {{name}}",
    "continueExploration": "Continue your exploration in {{model}}."
  },
  "teacher": {
  ...
  "socraticModal": {
    ...
    "specialties": {
      "ortopedia": {
        "label": "Orthopedics & Traumatology",
        "desc": "Fractures, joints, tendons, and limb injuries"
      },
      "neurologia": {
        "label": "Neurology & Neurosurgery",
        "desc": "Nerve plexuses, cranial nerves, and CNS"
      },
      "cirurgia": {
        "label": "General Surgery & Topographic Anatomy",
        "desc": "Abdominal wall, anatomical triangles, and viscera"
      },
      "cardiologia": {
        "label": "Cardiology & Vascular System",
        "desc": "Cardiac vascularization, aorta, and great vessels"
      },
      "ginecologia": {
        "label": "Gynecology & Pelvic Anatomy",
        "desc": "Female pelvis, pelvic floor, and retroperitoneum"
      }
    },
    "difficulties": {
      "basico": {
        "label": "Basic Cycle (1st - 4th Semester)",
        "desc": "Anatomical identification, landmarks, and direct relations"
      },
      "clinico": {
        "label": "Clinical Cycle (5th - 8th Semester)",
        "desc": "Pathophysiology, physical exams, and imaging findings"
      },
      "avancado": {
        "label": "Internship & Residency",
        "desc": "Complex differential diagnosis and anatomical variations"
      }
    }
  },
  "spatialAI": {
  ...
  "modelData": {
    ...
    "coracao-humano-superficial": {
      ...
      "clinicalCorrelations": [
        ...
        "Heart failure",
        "Cardiomegaly",
        "Correlation with X-ray, CT, and echocardiography"
      ],
      "studyGuide": [
      ...
      "reference": "3D model hosted on the Digital Cadaveric Library. Author: H2N.Engenharia.",
      "relatedStructures": [
        "Cardiac apex",
        "Base of the heart",
        "Sternocostal surface",
      ...
      "references": [
        "3D model hosted on the Digital Cadaveric Library. Author: H2N.Engenharia.",
    ...
    "corte-sagital-cranio-humano-superficial": {
      ...
      "clinicalCorrelations": [
        "Introductory reading of median sections",
        "Neuroimaging correlation",
        "Topography of upper airways",
        "Applied skull-base anatomy"
      ],
      "studyGuide": [
  ...
  "viewer": {
    ...
    "integratedSketchfab": "Integrated 3D Viewer",
    ...
    "sketchfabReference": "3D model hosted on the Digital Cadaveric Library. Author: {{author}}.",
  ...
  "institutionAdmin": {
    ...
    "pdfExportPrepared": "PDF export is not available yet.",
    "name": "Name",
    "email": "Email",
    "registration": "Student ID",
    "course": "Program",
  ...
  "settings": {
    ...
    "codeUnavailable": "Institutional code validation is not integrated yet.",
  ...
  "muralModular": {
    "eyebrow": "AUTONOMOUS STUDY • DENSE NOTES",
    "title": "Modular Anatomical Study Wall",
    "pinnedNotesCount": "{{count}} / {{total}} PINNED NOTES",
    "cancelMove": "Cancel Move",
    "selected": "SELECTED",
    "touchBanner": "💡 Note [{{coord}}] selected. Tap on any block to swap position, or tap it again to open.",
    "editPostit": "Edit Post-It",
    "newPostit": "New Post-It [Block {{coord}}]",
    "shortTitleLabel": "Short Title",
    "shortTitlePlaceholder": "Ex: BICEPS BRACHII ORIGIN",
    "contentLabel": "Note / Summary",
    "contentPlaceholder": "Describe anatomical details, review landmarks or quiz observations...",
    "glassToneLabel": "Glass Tone",
    "saveNote": "Save Note",
    "cancel": "Cancel",
    "delete": "Delete",
    "edit": "Edit",
    "close": "Close",
    "academicPostit": "BLOCK {{coord}} • ACADEMIC POST-IT"
  },
  "tutor": {
    "title": "Atlas AI Tutor",
    "tagline": "Anatomical tutor",
    "taglineUpper": "ANATOMICAL TUTOR",
    "contextualAssistance": "Contextual assistance",
    "synchronizedConversation": "Synchronized conversation across the platform",
    "analyzingQuestion": "Analyzing your question…",
    "compactMode": "Compact mode",
    "expandedMode": "Expanded mode",
    "close": "Close Atlas AI Tutor",
    "stateAnalyzing": "Analyzing",
    "stateListening": "Listening",
    "stateAnatomicalTutor": "Anatomical tutor",
    "atlasResponse": "Atlas Response",
    "contextualResponse": "Contextual response",
    "analyzing": "Atlas AI is analyzing",
    "processingRequest": "Atlas is processing your request…",
    "askAriaLabel": "Ask Atlas AI Tutor",
    "defaultPlaceholder": "Ask about anatomy, review or performance…",
    "sendQuestion": "Send question",
    "currentContext": "Current context",
    "welcomeGreeting": "Hello, {{name}}! I am the Atlas AI Tutor. This conversation accompanies you across the entire platform. I can explain structures, connect topics, and maintain your study continuity across the Atlas, library, and 3D models.",
    "welcomeGreetingGeneric": "Hello! I am the Atlas AI Tutor. This conversation accompanies you across the entire platform. I can explain structures, connect topics, and maintain your study continuity across the Atlas, library, and 3D models."
  }
};
